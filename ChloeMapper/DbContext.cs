...
namespace Dapper.Extensions.Expression
{
    public abstract partial class DbContext : IDbContext, IDisposable
    {
        ...
        {
            KeyValuePairList<JoinType, System.Linq.Expressions.Expression> joinInfos = ResolveJoinInfo(joinInfo);
        ...
        protected virtual async Task<object> Insert<TEntity>(Expression<Func<TEntity>> content, string table, bool @async)
        {
            ...
            Dictionary<MemberInfo, System.Linq.Expressions.Expression> insertColumns = InitMemberExtractor.Extract(content);
        ...
        protected virtual async Task<int> Update<TEntity>(Expression<Func<TEntity, bool>> condition, Expression<Func<TEntity, TEntity>> content, string table, bool @async)
        {
            ...
            Dictionary<MemberInfo, System.Linq.Expressions.Expression> updateColumns = InitMemberExtractor.Extract(content);
