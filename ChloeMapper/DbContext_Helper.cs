...
namespace Dapper.Extensions.Expression
{
    public abstract partial class DbContext : IDbContext, IDisposable
    {
        ...
        static KeyValuePairList<JoinType, System.Linq.Expressions.Expression> ResolveJoinInfo(LambdaExpression joinInfoExp)
        {
            /*
             * Usage:
            ...
            */
            ...
            KeyValuePairList<JoinType, System.Linq.Expressions.Expression> ret = new KeyValuePairList<JoinType, System.Linq.Expressions.Expression>();
            ...
            for (int i = 0; i < joinInfoExp.Parameters.Count - 1; i++)
            {
                ...
                System.Linq.Expressions.Expression joinTypeExpression = body.Expressions[indexOfJoinType];
                 ...
                 */
                System.Linq.Expressions.Expression joinCondition = body.Expressions[indexOfJoinType + 1].StripConvert();
                ...
                LambdaExpression lambdaOfJoinCondition = System.Linq.Expressions.Expression.Lambda(delegateType, joinCondition, parameters);
