...
{
    public class JoinQuery<T1, T2> : IJoinQuery<T1, T2>
    {
        ...
        public IQuery RootQuery { get { return this._rootQuery; } }
        ...
        public IQuery<TResult> Select<TResult>(Expression<Func<T1, T2, TResult>> selector)
        {
            if (this._filterPredicates.Count == 0)
            {
                ...
                return new Query<TResult>(this.DbContext, e1, false);
            }
            ...
            IQuery<JoinResult<T1, T2>> q = new Query<JoinResult<T1, T2>>(this.DbContext, e, false);


            ParameterExpression parameter = System.Linq.Expressions.Expression.Parameter(joinResultType, "a");
            System.Linq.Expressions.Expression[] expressionSubstitutes = QueryHelper.MakeExpressionSubstitutes(joinResultType, parameter);
    ...
    public class JoinQuery<T1, T2, T3> : IJoinQuery<T1, T2, T3>
    {
        DbContext _dbContext;
        ...
        public QueryExpression QueryExpression => throw new NotImplementedException();
        ...
        public IQuery<TResult> Select<TResult>(Expression<Func<T1, T2, T3, TResult>> selector)
        {
            ...
            JoinQueryExpression e = new JoinQueryExpression(joinResultType, this._rootQuery.QueryExpression, this._joinedQueries, joinResultSelector);
            IQuery<JoinResult<T1, T2, T3>> q = new Query<JoinResult<T1, T2, T3>>(this.DbContext, e, false);
    ...
    class JoinQuery<T1, T2, T3, T4> : IJoinQuery<T1, T2, T3, T4>
    {
        ...
        public IQuery<TResult> Select<TResult>(Expression<Func<T1, T2, T3, T4, TResult>> selector)
        {
            ...
            JoinQueryExpression e = new JoinQueryExpression(joinResultType, this._rootQuery.QueryExpression, this._joinedQueries, joinResultSelector);
            IQuery<JoinResult<T1, T2, T3, T4>> q = new Query<JoinResult<T1, T2, T3, T4>>(this.DbContext, e, false);
    ...
    class JoinQuery<T1, T2, T3, T4, T5> : IJoinQuery<T1, T2, T3, T4, T5>
    {
        ...
        public IQuery<TResult> Select<TResult>(Expression<Func<T1, T2, T3, T4, T5, TResult>> selector)
        {
            ...
            JoinQueryExpression e = new JoinQueryExpression(joinResultType, this._rootQuery.QueryExpression, this._joinedQueries, joinResultSelector);
            IQuery<JoinResult<T1, T2, T3, T4, T5>> q = new Query<JoinResult<T1, T2, T3, T4, T5>>(this.DbContext, e, false);
