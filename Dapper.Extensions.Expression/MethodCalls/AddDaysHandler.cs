...
{
    internal class AddDaysHandler : AbstractMethodCallHandler
    {
        public override string MethodName => "AddDays";
        ...
        {
            sqlAdapter.DateTimeAddMethod(e, "DAY", sqlAdapter, builder, parameters, appendParameter);
        }
    }
}
