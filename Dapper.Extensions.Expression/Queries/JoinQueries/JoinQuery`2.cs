...
namespace Dapper.Extensions.Expression.Queries.JoinQueries
{
    ...
    public sealed class JoinQuery<T1, T2> : AbstractQuery, IQuery
    {
        /// <summary>
        /// 默认select选择器
        /// </summary>
        private static readonly Expression<Func<T1, T2, T1>> FirstSelector = (t1, t2) => t1;
        ...
        internal JoinQuery(IDbConnection connection) : base(connection, 1)
        {
        }

        public JoinQuery<T1, T2> On(JoinType joinType, Expression<Func<T1, T2, bool>> on)
        {
            SetOn(joinType, on, 0);
            return this;
        }
        ...
        /// <param name="ex"></param>
        /// <returns></returns>
        public JoinQuery<T1, T2> Where(Expression<Func<T1, T2, bool>> ex)
        {
            base.Where(ex);
            return this;
        }
        ...
        /// <returns></returns>
        public JoinQuery<T1, T2> WhereIf(bool condition, Expression<Func<T1, T2, bool>> ex)
        {
            base.WhereIf(condition, ex);
            return this;
        }

        public JoinQuery<T1, T2> Exist<T3>(Expression<Func<T1, T2, T3, bool>> where)
        {
            base.Exist(where);
            return this;
        }

        public JoinQuery<T1, T2> NotExist<T3>(Expression<Func<T1, T2, T3, bool>> where)
        {
            base.NotExist(where);
            return this;
        }

        public JoinQuery<T1, T2> Between<TK>(Expression<Func<T1, T2, TK>> selector, TK left, TK right)
        {
        ...
        /// <returns></returns>
        public JoinQuery<T1, T2> TakePage(int page, int pageSize)
        {
            SetPage(page);
        ...
        /// <param name="pageSize"></param>
        /// <returns></returns>
        public JoinQuery<T1, T2> Take(int pageSize)
        {
            SetPageSize(pageSize);
            return this;
        }
        ...
        public JoinQuery<T1, T2> GroupBy<TK>(Expression<Func<T1, T2, TK>> keySelector)
        {
            base.GroupBy(keySelector);
            return this;
        }

        public JoinQuery<T1, T2> Having(Expression<Func<T1, T2, bool>> keySelector)
        {
        ...
        public JoinQuery<T1, T2> Select<T4>(Expression<Func<T1, T2, T4>> selector)
        {
            base.Select(selector);
            return this;
        }

        public JoinQuery<T1, T2> Distinct()
        {
            SetDistinct();
            return this;
        }
