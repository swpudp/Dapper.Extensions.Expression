...
namespace Dapper.Extensions.Expression.Queries.JoinQueries
{
    ...
    public sealed class JoinQuery<T1, T2, T3, T4, T5, T6> : AbstractQuery, IQuery
    {
        ...
        public JoinQuery<T1, T2, T3, T4, T5, T6> NotExist<T7>(Expression<Func<T1, T2, T3, T4, T5, T6, T7, bool>> where)
        {
            base.NotExist(where);
            return this;
        }
        ...
        public JoinQuery<T1, T2, T3, T4, T5, T6> OrderBy(string propertyName)
        {
            OrderByPropertyName(propertyName, ConstantDefined.OrderAsc);
            return this;
        }

        public JoinQuery<T1, T2, T3, T4, T5, T6> OrderByDescending(string propertyName)
        {
